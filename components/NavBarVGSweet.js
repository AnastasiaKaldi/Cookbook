...
const NavBarVGSweet = () => {
  ...
  return (
    <div className="vgsweetnav top-0 w-full z-10">
      <div className="container mx-auto flex justify-between items-center py-4 px">
        <div
          className="heading hover:text-[rgb(71,7,69)] text-4xl text-white"
        ...
        <div className="flex gap-6">
          <div
            className="hover:text-[rgb(74,8,83)] text-white cursor-pointer relative"
          ...
          >
            Salty
            {activeDropdown === 1 && (
              <div className="dropdown-menu-vgsweet absolute bg-White shadow">
