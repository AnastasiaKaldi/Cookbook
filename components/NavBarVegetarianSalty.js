...
const NavBarVegetarianSalty = () => {
  ...
  return (
    <div className="vnavsalty top-0 w-full z-10">
      <div className="container mx-auto flex justify-between items-center py-4 px">
        ...
        <div className="flex gap-6">
          ...
          >
            Salty
            {activeDropdown === 1 && (
              <div className="dropdown-menu-vegetariansalty absolute bg-White shadow">
...
export default NavBarVegetarianSalty;
