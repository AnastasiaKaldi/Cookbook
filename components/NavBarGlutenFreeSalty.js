...
const NavBarGlutenFreeSalty = () => {
  ...
  return (
    <div className="glutenfreesaltynav top-0 w-full z-10">
      <div className="container mx-auto flex justify-between items-center py-4 px">
        ...
        <div className="flex gap-6">
          <Link href="/" passHref>
            <div
              className="hover:text-[rgb(121,97,28)] text-white cursor-pointer relative"
          ...
          >
            Salty
            {activeDropdown === 1 && (
              <div className="dropdown-menu-glutenfreesalty absolute bg-White shadow">
...
export default NavBarGlutenFreeSalty;
